  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 h-[400px]">
      <div className="mb-6 border-b border-slate-100 pb-4">
        <h3 className="text-base font-serif font-bold text-slate-900">Şekil 1.1: Araştırma Yöntemleri Değişimi</h3>
        <p className="text-xs text-slate-500 mt-1">Akademik tarih araştırmalarında dijital arşiv kullanımının fiziksel arşivlere oranı (2010-2024).</p>
      </div>
