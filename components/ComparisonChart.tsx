...
export const ComparisonChart: React.FC = () => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-100 my-8">
      <div className="mb-6">
        <h3 className="text-lg font-serif font-bold text-slate-900">Zaman Maliyeti Analizi (Dakika)</h3>
        <p className="text-sm text-slate-500 mt-1">Geleneksel yöntemler ile dijital araçların ortalama işlem süreleri karşılaştırması.</p>
      </div>
